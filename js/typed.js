!(function (e, t, n) {
  ...
  function s(e, n, i, s) {
    ...
    if (parseInt(i, 10))
      for (; i--; )
        (u = r("div")), (u.id = s ? s[i] : p + (i + 1)), h.appendChild(u);
    return (
      (o = r("style")),
      (o.type = "text/css"),
      (o.id = "s" + p),
      ...
      (l = n(h, e)),
      f.fake
        ? (f.parentNode.removeChild(f), (d.style.overflow = c), d.offsetHeight)
    ...
    (function () {
      ...
      for (var d in o)
        if (o.hasOwnProperty(d)) {
          ...
          for (
            r = i(t.fn, "function") ? t.fn() : t.fn, a = 0;
            a < e.length;
            a++
          )
            (s = e[a]),
              1 === (l = s.split(".")).length
                ? (u[l[0]] = r)
                : (!u[l[0]] ||
                    u[l[0]] instanceof Boolean ||
                    (u[l[0]] = new Boolean(u[l[0]])),
                  (u[l[0]][l[1]] = r)),
              c.push((r ? "" : "no-") + l.join("-"));
        }
    })(),
  ...
  (function (e, t) {
    ...
    function g(e, t) {
      for (var n, i, r = [], a = 0, s = e.length; a < s; a++)
        (i = e[a]).style &&
          ...
          t
            ? ("none" === n &&
                ((r[a] = ze.get(i, "display") || null),
                r[a] || (i.style.display = "")),
              "" === i.style.display && Be(i) && (r[a] = m(i)))
            : "none" !== n && ((r[a] = "none"), ze.set(i, "display", n)));
    ...
    function w(e, t, n, i, r) {
      ...
      for (d.textContent = "", h = 0; (a = p[h++]); )
        if (i && fe.inArray(a, i) > -1) r && r.push(a);
          ...
          ((u = fe.contains(a.ownerDocument, a)),
    ...
    function I(e, t) {
      ...
      if (1 === t.nodeType) {
        if (
          ze.hasData(e) &&
          ((a = ze.access(e)), (s = ze.set(t, a)), (u = a.events))
        ) {
        ...
        Ne.hasData(e) &&
          ((o = Ne.access(e)), (l = fe.extend({}, o)), Ne.set(t, l));
      }
    }
    function L(e, t) {
    ...
    function P(e, t, i, r) {
      ...
      if (
        ...
        for (l = (o = fe.map(y(a, "script"), k)).length; d < p; d++)
          (u = a),
            d !== h &&
              ((u = fe.clone(u, !0, !0)), l && fe.merge(o, y(u, "script"))),
            i.call(e[d], u, d);
        if (l)
          for (
            c = o[o.length - 1].ownerDocument, fe.map(o, M), d = 0;
            d < l;
            d++
          )
            (u = o[d]),
              Xe.test(u.type || "") &&
                !ze.access(u, "globalEval") &&
                fe.contains(c, u) &&
                (u.src
                  ? fe._evalUrl && fe._evalUrl(u.src)
                  : n(u.textContent.replace(it, ""), c));
      }
      return e;
    }
    function D(e, t, n) {
      for (var i, r = t ? fe.filter(t, e) : e, a = 0; null != (i = r[a]); a++)
        n || 1 !== i.nodeType || fe.cleanData(y(i)),
          i.parentNode &&
            (n && fe.contains(i.ownerDocument, i) && b(y(i, "script")),
    ...
    function H(e, t, n, i, r) {
      var a,
        s = 0;
      for (
        a = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0;
        a < 4;
        a += 2
      )
        "margin" === n && (s += fe.css(e, n + qe[a], !0, r)),
          i
            ? ("content" === n && (s -= fe.css(e, "padding" + qe[a], !0, r)),
              "margin" !== n &&
                (s -= fe.css(e, "border" + qe[a] + "Width", !0, r)))
            : ((s += fe.css(e, "padding" + qe[a], !0, r)),
              "padding" !== n &&
                (s += fe.css(e, "border" + qe[a] + "Width", !0, r)));
      return s;
    }
    function j(e, t, n) {
      ...
      return at.test(a)
        ? a
        : ((i = s && (pe.boxSizingReliable() || a === e.style[t])),
        ...
        if ((i = W.prefilters[a].call(u, e, c, u.opts)))
          return (
            fe.isFunction(i.stop) &&
              (fe._queueHooks(u.elem, u.opts.queue).stop = fe.proxy(i.stop, i)),
            i
          );
      return (
        fe.map(c, R, u),
    ...
    var be = (function (e) {
      function t(e, t, n, i) {
        ...
        if (
          !i &&
          ((t ? t.ownerDocument || t : F) !== D && P(t), (t = t || D), A)
        ) {
          if (11 !== f && (l = ve.exec(e)))
            if ((r = l[1])) {
              if (9 === f) {
        ...
        return (
          ...
          i(function (i, s, o, l) {
            var u,
              ...
              b = n ? (a || (i ? e : m || r) ? [] : s) : y;
            if ((n && n(y, b, o, l), r))
              for (u = v(b, h), r(u, [], o, l), c = u.length; c--; )
                (d = u[c]) && (b[h[c]] = !(y[h[c]] = d));
            if (i) {
              if (a || e) {
                if (a) {
        ...
        var r = n.length > 0,
          ...
          s = function (i, s, o, l, u) {
            ...
            for (
              ...
              if (a && c) {
                for (
                  d = 0, s || c.ownerDocument === D || (P(c), (o = !A));
                  (p = e[d++]);
      ...
      (w = t.support = {}),
        ...
        (t.attr = function (e, t) {
          ...
          var n = x.attrHandle[t.toLowerCase()],
            i =
              n && X.call(x.attrHandle, t.toLowerCase()) ? n(e, t, !A) : void 0;
          return void 0 !== i
            ? i
            : w.attributes || !A
            ? e.getAttribute(t)
      ...
      return (
        ...
        (C = t.tokenize = function (e, n) {
          ...
          for (o = e, l = [], u = x.preFilter; o; ) {
            (i && !(r = se.exec(o))) ||
              ...
              (r = oe.exec(o)) &&
                ((i = r.shift()),
                a.push({ value: i, type: r[0].replace(ae, " ") }),
                (o = o.slice(i.length)));
            for (s in x.filter)
              !(r = de[s].exec(o)) ||
                (u[s] && !(r = u[s](r))) ||
        ...
        (k = t.select = function (e, t, n, i) {
          ...
          if (((n = n || []), 1 === p.length)) {
            ...
            for (
              r = de.needsContext.test(e) ? 0 : a.length;
              r-- && ((s = a[r]), !x.relative[(o = s.type)]);

            )
              if (
                (l = x.find[o]) &&
                (i = l(
                  s.matches[0].replace(ge, ye),
                  (me.test(a[0].type) && u(t.parentNode)) || t
                ))
              ) {
    ...
    (fe.filter = function (e, t, n) {
      ...
      fe.fn.extend({
        ...
        is: function (e) {
          return !!a(
            this,
            "string" == typeof e && Te.test(e) ? fe(e) : e || [],
            !1
          ).length;
        },
      });
        ...
        function (e, t) {
          fe.fn[e] = function (n, i) {
            ...
            return (
              ...
              this.length > 1 &&
                (Ie[e] || fe.uniqueSort(r), Me.test(e) && r.reverse()),
              this.pushStack(r)
            );
          };
        }
    ...
    (fe.Callbacks = function (e) {
                ...
                (function t(n) {
                  fe.each(n, function (n, i) {
                    fe.isFunction(i)
                      ...
                      : i && i.length && "string" !== fe.type(i) && t(i);
                  });
                })(arguments),
                n && !t && u()),
              this
      ...
      fe.extend({
            ...
            r = {
              ...
              then: function (t, i, r) {
                ...
                return fe
                  .Deferred(function (e) {
                    n[0][3].add(
                      a(0, e, fe.isFunction(r) ? r : l, e.notifyWith)
                    ),
        ...
        when: function (e) {
          ...
          if (
            t <= 1 &&
            (c(e, a.done(s(n)).resolve, a.reject, !t),
      ...
      fe.fn.extend({
        data: function (e, t) {
          ...
          if (void 0 === e) {
            if (
              this.length &&
              ((r = Ne.get(a)), 1 === a.nodeType && !ze.get(a, "hasDataAttrs"))
            ) {
              for (n = s.length; n--; )
                s[n] &&
                  0 === (i = s[n].name).indexOf("data-") &&
                  ((i = fe.camelCase(i.slice(5))), f(a, i, r[i]));
        ...
        queue: function (e, t, n) {
          ...
          if (e)
            return (
              ...
              n &&
                (!i || Array.isArray(n)
                  ? (i = ze.access(e, t, fe.makeArray(n)))
                  : i.push(n)),
              i || []
            );
        },
    ...
    (fe.event = {
      ...
      dispatch: function (e) {
        ...
        if (
          ...
          for (
            s = fe.event.handlers.call(this, o, u), t = 0;
            ...
            for (
              ...
              (o.rnamespace && !o.rnamespace.test(a.namespace)) ||
                ...
                void 0 !==
                  (i = (
                    (fe.event.special[a.origType] || {}).handle || a.handler
                  ).apply(r.elem, l)) &&
                  !1 === (o.result = i) &&
    ...
    fe.extend({
      ...
      clone: function (e, t, n) {
        ...
        if (
          ...
          for (s = y(o), a = y(e), i = 0, r = a.length; i < r; i++)
            L(a[i], s[i]);
        if (t)
          if (n)
            for (a = a || y(e), s = s || y(o), i = 0, r = a.length; i < r; i++)
              I(a[i], s[i]);
          else I(e, o);
      ...
      cleanData: function (e) {
        for (
          var t, n, i, r = fe.event.special, a = 0;
          void 0 !== (n = e[a]);
          a++
        )
          if (Ae(n)) {
        ...
        fe.cssHooks[t] = {
          ...
          set: function (e, n, i) {
            var r,
              ...
              s =
                i &&
                H(e, t, i, "border-box" === fe.css(e, "boxSizing", !1, a), a);
            return (
              s &&
                (r = Fe.exec(n)) &&
                "px" !== (r[3] || "px") &&
            ...
            for (i in h)
              l ||
                (m
                  ...
                  : (m = ze.access(e, "fxshow", { display: u })),
                a && (m.hidden = !v),
                v && g([e], !0),
                p.done(function () {
            ...
            return void 0 === e.getAttribute
              ...
              : ((1 === a && fe.isXMLDoc(e)) ||
                  (r =
                    ...
                    (fe.expr.match.bool.test(t) ? gt : void 0)),
                void 0 !== n
                  ? null === n
    ...
    fe.fn.extend({
      val: function (e) {
        ...
        return arguments.length
          ...
          : r
          ? (t =
              fe.valHooks[r.type] || fe.valHooks[r.nodeName.toLowerCase()]) &&
            "get" in t &&
      ...
      fe.extend({
        valHooks: {
          ...
          select: {
            ...
            set: function (e, t) {
              for (
                var n, i, r = e.options, a = fe.makeArray(t), s = r.length;
                s--;

              )
                (i = r[s]),
                  (i.selected =
                    fe.inArray(fe.valHooks.option.get(i), a) > -1) && (n = !0);
      ...
      trigger: function (t, n, i, r) {
        ...
        if (
          ...
          3 !== i.nodeType &&
            ...
            (t = t[fe.expando]
              ? t
              : new fe.Event(h, "object" == typeof t && t)),
            (t.isTrigger = r ? 2 : 3),
            (t.namespace = f.join(".")),
          ...
          if (!r && !d.noBubble && !fe.isWindow(i)) {
            for (
              l = d.delegateType || h, Tt.test(l + h) || (s = s.parentNode);
              s;
              s = s.parentNode
            )
              p.push(s), (o = s);
            o === (i.ownerDocument || te) &&
              p.push(o.defaultView || o.parentWindow || e);
          }
          for (a = 0; (s = p[a++]) && !t.isPropagationStopped(); )
            (t.type = a > 1 ? l : d.bindType || h),
              (c =
                (ze.get(s, "events") || {})[t.type] && ze.get(s, "handle")) &&
                c.apply(s, n),
              (c = u && s[u]) &&
                c.apply &&
                Ae(s) &&
    ...
    (qt.href = Et.href),
        ...
        ajax: function (t, n) {
          function i(t, n, i, o) {
            ...
            c ||
              ...
              u
                ? (f.ifModified &&
                  ...
                  204 === t || "HEAD" === f.type
                    ...
                    : 304 === t
                    ? (T = "notmodified")
                    : ((T = w.state), (p = w.data), (h = w.error), (u = !h)))
              ...
              (b = void 0),
              d &&
                m.trigger(u ? "ajaxSuccess" : "ajaxError", [E, f, u ? p : h]),
              y.fireWith(v, [E, T]),
              d &&
          ...
          (d = fe.event && f.global) &&
            ...
            f.hasContent
              ...
              : ((h = f.url.slice(a.length)),
                f.data &&
                  ((a += (St.test(a) ? "&" : "?") + f.data), delete f.data),
                !1 === f.cache &&
                  ((a = a.replace(Ot, "$1")),
                  (h = (St.test(a) ? "&" : "?") + "_=" + Ct++ + h)),
                (f.url = a + h)),
            f.ifModified &&
              (fe.lastModified[a] &&
                E.setRequestHeader("If-Modified-Since", fe.lastModified[a]),
      ...
      fe.each(["get", "post"], function (e, t) {
        fe[t] = function (e, n, i, r) {
          return (
            fe.isFunction(n) && ((r = r || i), (i = n), (n = void 0)),
            fe.ajax(
              fe.extend(
    ...
    fe.ajaxSetup({
      ...
      fe.ajaxPrefilter("json jsonp", function (t, n, i) {
        ...
        if (o || "jsonp" === t.dataTypes[0])
          return (
            (r = t.jsonpCallback = fe.isFunction(t.jsonpCallback)
              ? t.jsonpCallback()
              : t.jsonpCallback),
            o
              ? (t[o] = t[o].replace(_t, "$1" + r))
              : !1 !== t.jsonp &&
      ...
      fe.each(["top", "left"], function (e, t) {
        fe.cssHooks[t] = A(pe.pixelPosition, function (e, n) {
          if (n)
            return (n = O(e, t)), at.test(n) ? fe(e).position()[t] + "px" : n;
        });
      }),
    ...
    return (
      (fe.noConflict = function (t) {
        return (
          e.$ === fe && (e.$ = Xt), t && e.jQuery === fe && (e.jQuery = Wt), fe
        );
      }),
      t || (e.jQuery = e.$ = fe),
      fe
    ...
    (e.easing.jswing = e.easing.swing),
      e.extend(e.easing, {
        ...
        easeInElastic: function (e, t, n, i, r) {
          ...
          return 0 == t
            ...
            : (a || (a = 0.3 * r),
              s < Math.abs(i)
                ? ((s = i), (e = a / 4))
                : (e = (a / (2 * Math.PI)) * Math.asin(i / s)),
              -s *
                Math.pow(2, 10 * --t) *
                Math.sin((2 * (t * r - e) * Math.PI) / a) +
                n);
        },
        ...
        easeInOutBounce: function (t, n, i, r, a) {
          return n < a / 2
            ? 0.5 * e.easing.easeInBounce(t, 2 * n, 0, r, a) + i
            : 0.5 * e.easing.easeOutBounce(t, 2 * n - a, 0, r, a) + 0.5 * r + i;
        },
      });
  })(jQuery),
  (function (e) {
    ...
    e.html5Loader = function (t) {
      var n = {
        ...
        b = navigator.userAgent.match(
          /iPad|Android|(?=.*\bWindows\b)(?=.*\bARM\b)/i
        ),
        w = (function (e) {
          return !(
      ...
      var E = function (t) {
          ...
          return (
            e.each(i, function (e) {
              if (x[n][e])
                return (t = t.sources[e]), (t.type = n.toUpperCase()), !1;
            }),
            !!t.source && t
          );
        },
        ...
        M = function (t) {
          if (!i.cancelLoading) {
            var n,
              ...
              s = e("<img>");
            return (
              "[object Object]" === t.source.toString()
                ? t.source.svg && x.svg
                  ? (n = t.source.svg)
                  : t.source.fallback && (n = t.source.fallback)
                : (n = t.source),
              s.on("load", function () {
                T("File Loaded:" + n),
                  (m += a),
                    ...
                    a.on("progress", function () {
                      ...
                      T("loading in progress file:" + t.source),
                        this.buffered.length > 0 &&
                          ((e = (r / this.duration) * this.buffered.end(0)),
                          (r -= e),
                          (m += e),
                          C(),
                          (1 / r) * e > s && !o && l());
        ...
        D = function () {
          ...
          e.each(t, function (e, t) {
            switch (
              (T("preloading files"), T("file to preload:" + t.source), t.type)
            ) {
              case "IMAGE":
                M(t);
                break;
      ...
      return (
        (this.init = function () {
          ...
          u(),
            "object" == typeof r
              ? (e.proxy(k, this, r)(), t.resolve(r))
              : (e.getJSON(r, t.resolve), t.pipe(e.proxy(k, this))),
  ...
  (function (e) {
    ...
    (o.prototype = {
      ...
      init: function (t) {
        var n = this;
        if (
          ((n.options = e.extend(!0, {}, e.fn[i].defaults, n.options, t)),
        ...
        if (t.state.multiple) {
          ...
          (r = e.grep(r, function (t) {
            ...
            t.options.multiple.maxLabelEntries &&
              (r.length >= t.options.multiple.maxLabelEntries + 1
                ? (r = r.slice(0, t.options.multiple.maxLabelEntries)).push(
                    e.isFunction(n)
                      ? n({ text: "..." })
            ...
            void 0 !== r.label
              ? ((i += n.utils.format(
                  ...
                  n.utils.arrayToClassname([
                    n.classes.group,
                    r.groupDisabled ? "disabled" : "",
                    r.element.prop("class"),
                  ]),
      ...
      bindEvents: function () {
        var t = this;
        t.elements.outerWrapper.on("mouseenter.sl mouseleave" + r, function (
          n
        ) {
                ...
                clearTimeout(t.resetStr),
                  ...
                  n.length &&
                    e.each(t.items, function (e, n) {
                      ((!n.disabled && i.test(n.text)) || i.test(n.slug)) &&
                        t.highlight(e);
                    });
              })),
          t.$li.on({
      ...
      handleKeys: function (t) {
        ...
        return o && n.state.opened
          ? (n.select(u),
            void (
              (n.state.multiple && n.options.multiple.keepMenuOpen) ||
              n.close()
            ))
          : void (l && !n.state.opened && n.open());
      },
      refresh: function () {
        var e = this;
      ...
      isInViewport: function () {
        var e = this,
          ...
          a =
            r + e.elements.outerWrapper.outerHeight() + e.itemsHeight <= t + i,
          s = r - e.itemsHeight > t,
          o = !a && s;
      ...
      detectItemVisibility: function (t) {
        ...
        n.elements.itemsScroll.scrollTop(
          s > a + n.itemsHeight ? s - n.itemsHeight : r - i < a ? r - i : a
        );
      },
      open: function (n) {
        var a = this;
        return (
          ...
          void (
            ...
            setTimeout(function () {
              t.on("click" + r, e.proxy(a.close, a)).on(
                "scroll" + r,
                e.proxy(a.isInViewport, a)
              );
            }, 1),
            a.isInViewport(),
            a.options.preventWindowScroll &&
              t.on(
                "mousewheel.sl DOMMouseScroll" + r,
                "." + a.classes.scroll,
                function (t) {
                  ...
                  "detail" in n && (r = -1 * n.detail),
                    ...
                    ((i === this.scrollHeight - a.itemsInnerHeight && r < 0) ||
                      (0 === i && r > 0)) &&
                      t.preventDefault();
                }
              ),
      ...
      select: function (t) {
        ...
        if (
          ...
          if (n.state.multiple) {
            ...
            -1 !== r
              ? n.state.selectedIdx.splice(r, 1)
  ...
  (function (e, t, n, i) {
    ...
    function x(e, t) {
      for (
        var n, r, a = t[0].toUpperCase() + t.slice(1), s = 0;
        s < le.length;
    ...
    function I(e, t) {
      var n = t.center,
        ...
        r = e.prevDelta || {},
        a = e.prevInput || {};
      (t.eventType === Te || a.eventType === Ce) &&
        ((r = e.prevDelta = { x: a.deltaX || 0, y: a.deltaY || 0 }),
    ...
    (Y.prototype = {
      ...
      dropRecognizeWith: function (e) {
        return a(e, "dropRecognizeWith", this)
          ? this
          : ((e = Q(e, this)), delete this.simultaneous[e.id], this);
      },
      ...
      recognize: function (e) {
        ...
        return d(this.options.enable, [this, t])
          ? (this.state & (st | ot | 32) && (this.state = nt),
            (this.state = this.process(t)),
            void (this.state & (it | rt | at | ot) && this.tryEmit(t)))
      ...
      u(ee, Y, {
        ...
        process: function (e) {
          ...
          if (((this._input = e), !i || !n || (e.eventType & (Ce | Se) && !a)))
            this.reset();
  ...
  function s(e) {
    var n,
      ...
      o = {
        adjusted: s > 0,
        fontSize: parseFloat(
          window.getComputedStyle(r).getPropertyValue("font-size")
        ),
        width: s,
    ...
    for (c; c < u; c++) {
      i = (n = t(l[c])).length;
      for (var d = 0; d < i; d++)
        n[d].media.mediaText = n[d].media.mediaText.replace(
          /m(in|ax)-width:\s*(\d|\.)+(px|em)/gi,
          function (e) {
            if (e.match("px"))
...
(window.$clamp = function (e, t) {
  ...
  function r(e) {
    ...
    return (
      "normal" == t && (t = 1.2 * parseInt(n(e, "font-size"))), parseInt(t)
    );
  }
  function a(t) {
    return t.lastChild.children && 0 < t.lastChild.children.length
      ...
      : t.lastChild &&
        ...
        "" != t.lastChild.nodeValue &&
        t.lastChild.nodeValue != c.truncationChar
      ? t.lastChild
  ...
  function s(t, n) {
    if (n) {
      ...
      if (
        ...
        l &&
          ((t.nodeValue = t.nodeValue.replace(c.truncationChar, "")),
  ...
  c.truncationHTML &&
    ((l = document.createElement("span")), (l.innerHTML = c.truncationHTML));
  var m,
    g,
    y = c.splitOnChars.slice(0),
    b = y[0];
        ...
        on: function (t) {
          void 0 === t && (t = ""),
            (document.body.className =
              document.body.className + " " + e.classes + " " + t),
...
!(function (e, t) {
  ...
  function t(e, t, n) {
    (!n && w(e)) ||
      (k(t.callback_enter, e),
      A.indexOf(e.tagName) > -1 && (O(e, t), v(e, t.class_loading)),
      S(e, t),
      b(e),
      k(t.callback_set, e));
  }
  var n = function () {
    ...
    o = function (e, t, n) {
      return (
        (t === window ? window.pageYOffset : i(t)) >= i(e) + n + e.offsetHeight
      );
    },
    l = function (e, t, n) {
      return (
        (t === window ? window.pageXOffset : a(t)) >= a(e) + n + e.offsetWidth
      );
    },
    u = function (e, t) {
      var n,
        ...
        if ((o && (this._isFirstLoop = !1), 0 !== r)) {
          for (a = 0; a < r; a++) {
            ...
            (n.skip_invisible && null === l.offsetParent) ||
              ((p || t || e(l, n.container, n.threshold)) &&
                (o && v(l, n.class_initial), this.load(l), s.push(a)));
          }
          z(i, s);
  ...
  (function (e, t) {
            ...
            if (!d || !(o <= h || o >= u.screen.width - h)) {
              if (
                ...
                e(s.target).is(i.formElements) && (f = !1),
                  l.activeElement &&
                    e(l.activeElement).is(i.formElements) &&
                    l.activeElement !== s.target &&
        ...
        if (!i.isTouchEvent || "mousemove" !== o.type) {
          ...
          if (
            ...
            if (
              !(
                n.params.threshold &&
                Math.sqrt(Math.pow(d, 2) + Math.pow(h, 2)) < n.params.threshold
              )
            ) {
    ...
    function r(e) {
      ...
      if (
        ...
        (!i.freeModeMomentum || d >= i.longSwipesMs) &&
          (t.updateProgress(), t.updateActiveIndex(), t.updateSlidesClasses());
      } else {
        for (
          var M = 0, I = t.slidesSizesGrid[0], L = 0;
          L < o.length;
          L += i.slidesPerGroup
        )
          void 0 !== o[L + i.slidesPerGroup]
            ? h >= o[L] &&
              h < o[L + i.slidesPerGroup] &&
              ((M = L), (I = o[L + i.slidesPerGroup] - o[L]))
            : h >= o[L] && ((M = L), (I = o[o.length - 1] - o[o.length - 2]));
        var P = (h - o[M]) / I;
        if (d > i.longSwipesMs) {
          ...
          if (o)
            ...
            for (c = 0; c < d.length; c += 1) {
              ...
              h.dom7Listeners || (h.dom7Listeners = {}),
                ...
                h.dom7Listeners[v].push({ listener: l, proxyListener: n }),
        ...
        for (var o = i.split(" "), l = 0; l < o.length; l += 1)
          for (var u = o[l], c = 0; c < this.length; c += 1) {
            ...
            if (
              (!r && d.dom7Listeners
                ? (p = d.dom7Listeners[u])
                : r && d.dom7LiveListeners && (p = d.dom7LiveListeners[u]),
              p && p.length)
            )
      ...
      parent: function (n) {
        for (var i = [], r = 0; r < this.length; r += 1)
          null !== this[r].parentNode &&
            (n
              ? e(this[r].parentNode).is(n) && i.push(this[r].parentNode)
      ...
      parents: function (n) {
        for (var i = [], r = 0; r < this.length; r += 1)
          for (var a = this[r].parentNode; a; )
            n ? e(a).is(n) && i.push(a) : i.push(a), (a = a.parentNode);
        return e(t(i));
      },
      closest: function (e) {
        var t = this;
      ...
      children: function (n) {
        for (var i = [], r = 0; r < this.length; r += 1)
          for (var a = this[r].childNodes, s = 0; s < a.length; s += 1)
            n
              ? 1 === a[s].nodeType && e(a[s]).is(n) && i.push(a[s])
              : 1 === a[s].nodeType && i.push(a[s]);
        return new c(t(i));
      },
      remove: function () {
    ...
    var p = {
          ...
          for (var n = Object(e[0]), i = 1; i < e.length; i += 1) {
            ...
            if (void 0 !== r && null !== r)
              for (
                ...
                void 0 !== u &&
                  u.enumerable &&
                  (p.isObject(n[l]) && p.isObject(r[l])
                    ? p.extend(n[l], r[l])
                    : !p.isObject(n[l]) && p.isObject(r[l])
                    ? ((n[l] = {}), p.extend(n[l], r[l]))
                    : (n[l] = r[l]));
              }
          }
          return n;
      ...
      h = (function () {
        ...
        return {
          touch:
            (u.Modernizr && !0 === u.Modernizr.touch) ||
            !!(
              u.navigator.maxTouchPoints > 0 ||
              "ontouchstart" in u ||
              (u.DocumentTouch && l instanceof u.DocumentTouch)
            ),
          pointerEvents: !!(
            u.navigator.pointerEnabled ||
            u.PointerEvent ||
            ("maxTouchPoints" in u.navigator && u.navigator.maxTouchPoints > 0)
          ),
      ...
      f = (function () {
        return {
          isIE:
            !!u.navigator.userAgent.match(/Trident/g) ||
            !!u.navigator.userAgent.match(/MSIE/g),
      ...
      (v.prototype.emit = function () {
        ...
        return (
          "string" == typeof e[0] || Array.isArray(e[0])
            ? ((i = e[0]), (r = e.slice(1, e.length)), (a = n))
            : ((i = e[0].events), (r = e[0].data), (a = e[0].context || n)),
    ...
    var g = {
        updateSize: function () {
          ...
          (e = void 0 !== n.params.width ? n.params.width : i[0].clientWidth),
            (t =
              void 0 !== n.params.height ? n.params.height : i[0].clientHeight),
            (0 === e && n.isHorizontal()) ||
              (0 === t && n.isVertical()) ||
              ((e =
                e -
          ...
          if (0 !== r.length) {
            ...
            for (var o = 0; o < r.length; o += 1) {
              var l = r[o],
                u =
                  (s +
                    (i.centeredSlides ? n.minTranslate() : 0) -
                    l.swiperSlideOffset) /
      ...
      w = {
          ...
          return (
            ...
            (d && -f === r.translate) || (!d && f === r.translate)
              ? (r.updateActiveIndex(a),
                ...
                "reset" !== m &&
                  (r.transitionStart(n, m), r.transitionEnd(n, m)),
                !1)
              : (0 !== t && h.transition
                  ? (r.setTransition(t),
                    r.setTranslate(f),
        ...
        slidePrev: function (e, t, n) {
          ...
          var c,
            ...
            h =
              ...
              o[p.indexOf(d) - 1]);
          return (
            void 0 !== h && (c = l.indexOf(h)) < 0 && (c = r.activeIndex - 1),
            r.slideTo(c, e, t, n)
          );
        },
        ...
        slideToClickedSlide: function () {
          ...
          if (i.loop) {
            ...
            (t = parseInt(
              e(n.clickedSlide).attr("data-swiper-slide-index"),
              10
            )),
              i.centeredSlides
                ? s < n.loopedSlides - a / 2 ||
                  s > n.slides.length - n.loopedSlides + a / 2
                  ? (n.loopFix(),
                    (s = r
                      .children(
                        "." +
        ...
        loopCreate: function () {
          ...
          if (n.loopFillGroupWithBlank) {
            ...
            if (a !== n.slidesPerGroup) {
              for (var s = 0; s < a; s += 1) {
                var o = e(l.createElement("div")).addClass(
      ...
      C = (function () {
        ...
        if (
          ...
          a &&
            ((t.osVersion = a[3] ? a[3].replace(/_/g, ".") : null),
            (t.iphone = !0)),
          t.ios &&
            t.osVersion &&
            e.indexOf("Version/") >= 0 &&
        ...
        events: {
          attachEvents: function () {
              ...
              if (h.touch) {
                ...
                d.addEventListener(o.start, e.onTouchStart, f),
                  d.addEventListener(
                    o.move,
                    e.onTouchMove,
                    h.passiveListener ? { passive: !1, capture: p } : p
                  ),
                  d.addEventListener(o.end, e.onTouchEnd, f);
              }
              ((t.simulateTouch && !C.ios && !C.android) ||
                (t.simulateTouch && !h.touch && C.ios)) &&
                (d.addEventListener("mousedown", e.onTouchStart, !1),
            ...
            (t.preventClicks || t.preventClicksPropagation) &&
              d.addEventListener("click", e.onClick, !0),
              e.on(
                C.ios || C.android
      ...
      N = {
        update: function (e) {
          ...
          var w, x;
          s
            ? ((w = Math.floor(r / 2) + a + l), (x = Math.floor(r / 2) + a + u))
            : ((w = r + (a - 1) + l), (x = a + u));
          ...
          if (
            ...
            return (
              n.slidesGrid !== v && C !== g && n.slides.css(y, C + "px"),
      ...
      H = {
        ...
        enable: function () {
          var t = this;
          t.keyboard.enabled ||
            (e(l).on("keydown", t.keyboard.handle), (t.keyboard.enabled = !0));
        },
        disable: function () {
          var t = this;
          t.keyboard.enabled &&
            (e(l).off("keydown", t.keyboard.handle), (t.keyboard.enabled = !1));
        },
      },
      j = {
        name: "keyboard",
          ...
          if (n.nextEl || n.prevEl) {
            ...
            n.nextEl &&
              ...
              t.params.uniqueNavElements &&
                ...
                i.length > 1 &&
                1 === t.$el.find(n.nextEl).length &&
                (i = t.$el.find(n.nextEl))),
              n.prevEl &&
                ((r = e(n.prevEl)),
                t.params.uniqueNavElements &&
                  "string" == typeof n.prevEl &&
                  r.length > 1 &&
                  1 === t.$el.find(n.prevEl).length &&
                  (r = t.$el.find(n.prevEl))),
            ...
            if (
              (t.params.loop
                ? ((r = Math.ceil(
                    ...
                    a - 1 - 2 * t.loopedSlides && (r -= a - 2 * t.loopedSlides),
                  r > o - 1 && (r -= o),
              ...
              if (
                ...
                (d.eq(r).addClass(i.bulletActiveClass), i.dynamicBullets)
              ) {
        ...
        init: function () {
          ...
          if (n.el) {
            ...
            0 !== i.length &&
              ...
              "bullets" === n.type &&
                n.clickable &&
                i.addClass(n.clickableClass),
              i.addClass(n.modifierClass + n.type),
              "bullets" === n.type &&
                n.dynamicBullets &&
                (i.addClass("" + n.modifierClass + n.type + "-dynamic"),
                (t.pagination.dynamicBulletIndex = 0),
                n.dynamicMainBullets < 1 && (n.dynamicMainBullets = 1)),
              "progressbar" === n.type &&
                n.progressbarOpposite &&
                i.addClass(n.progressbarOppositeClass),
              n.clickable &&
          ...
          if (e.params.scrollbar.el) {
            ...
            h.touch
              ? (a.addEventListener(n.start, e.scrollbar.onDragStart, s),
                ...
                a.addEventListener(n.end, e.scrollbar.onDragEnd, o))
          ...
          if (e.params.scrollbar.el) {
            ...
            h.touch
              ? (a.removeEventListener(n.start, e.scrollbar.onDragStart, s),
                ...
                a.removeEventListener(n.end, e.scrollbar.onDragEnd, o))
        ...
        init: function () {
          ...
          if (t.params.scrollbar.el) {
            ...
            0 === s.length &&
              ...
              a.append(s)),
              p.extend(n, { $el: a, el: a[0], $dragEl: s, dragEl: s[0] }),
          ...
          if (
            ...
            (l =
              l.indexOf("%") >= 0
                ...
                : l * n * s + "px"),
            (u =
              u.indexOf("%") >= 0 ? parseInt(u, 10) * n + "%" : u * n + "px"),
            void 0 !== d && null !== d)
          ) {
      ...
      _ = {
        ...
        in: function (t) {
          ...
          if (
            (a.$slideEl ||
              ((a.$slideEl = n.clickedSlide
                ? e(n.clickedSlide)
                : n.slides.eq(n.activeIndex)),
              (a.$imageEl = a.$slideEl.find("img, svg, canvas")),
                      ...
                      if (
                        (l
                          ...
                          : (c &&
                            ...
                            d &&
                              (o.attr("sizes", d), o.removeAttr("data-sizes")),
      ...
      Y = {
        ...
        onEnterKey: function (t) {
          ...
          if (13 === t.keyCode) {
            ...
            n.navigation &&
              n.navigation.$nextEl &&
              r.is(n.navigation.$nextEl) &&
              ((n.isEnd && !n.params.loop) || n.slideNext(),
              n.isEnd
                ? n.a11y.notify(i.lastSlideMessage)
                : n.a11y.notify(i.nextSlideMessage)),
              n.navigation &&
                n.navigation.$prevEl &&
                r.is(n.navigation.$prevEl) &&
                ((n.isBeginning && !n.params.loop) || n.slidePrev(),
                n.isBeginning
                  ? n.a11y.notify(i.firstSlideMessage)
                  : n.a11y.notify(i.prevSlideMessage)),
              n.pagination &&
                r.is("." + n.params.pagination.bulletClass) &&
                r[0].click();
          }
        },
        notify: function (e) {
          ...
          t.pagination &&
            ...
            t.pagination.bullets.each(function (i, r) {
              ...
              t.a11y.makeElFocusable(a),
                ...
                t.a11y.addElLabel(
                  a,
                  n.paginationBulletMessage.replace(/{{index}}/, a.index() + 1)
                );
            });
        },
        init: function () {
            ...
            (t.initialized = !0),
              ...
              (t.paths.key || t.paths.value) &&
                ...
                e.params.history.replaceState ||
                  u.addEventListener("popstate", e.history.setHistoryPopState));
          }
        },
        destroy: function () {
          var e = this;
          e.params.history.replaceState ||
            u.removeEventListener("popstate", e.history.setHistoryPopState);
        },
          ...
          if (n.history.initialized && n.params.history.enabled) {
            ...
            (a && a.value === r) ||
              (n.params.history.replaceState
                ? u.history.replaceState({ value: r }, null, r)
                : u.history.pushState({ value: r }, null, r));
          }
        },
        slugify: function (e) {
          return e
        ...
        scrollToSlide: function (e, t, n) {
          ...
          if (t)
            for (var r = 0, a = i.slides.length; r < a; r += 1) {
              var s = i.slides.eq(r);
              if (
                G.slugify(s.attr("data-history")) === t &&
        ...
        init: function () {
          ...
          if (
            ...
            t.params.hashNavigation.watchState &&
              e(u).on("hashchange", t.hashNavigation.onHashCange);
          }
        },
        destroy: function () {
          var t = this;
          t.params.hashNavigation.watchState &&
            e(u).off("hashchange", t.hashNavigation.onHashCange);
        },
      },
      Q = {
        run: function () {
      ...
      Z = {
        setTranslate: function () {
          for (
            var t = this, n = t.slides, i = t.rtlTranslate, r = 0;
            r < n.length;
            r += 1
          ) {
            var a = n.eq(r),
      ...
      te = {
        ...
        onThumbClick: function () {
          ...
          if (n) {
            ...
            if (
              !(
                (r && e(r).hasClass(t.params.thumbs.slideThumbActiveClass)) ||
                void 0 === i ||
                null === i
              )
            ) {
          ...
          on: {
            ...
            click: function (t) {
              ...
              if (
                ...
                var s;
                r
                  ? (s = r.hasClass(n.params.navigation.hiddenClass))
                  : a && (s = a.hasClass(n.params.navigation.hiddenClass)),
                  !0 === s
            ...
            click: function (t) {
              ...
              n.params.pagination.el &&
                ...
                n.pagination.$el.hasClass(n.params.pagination.hiddenClass)
                  ? n.emit("paginationShow", n)
                  : n.emit("paginationHide", n),
      ...
      function (e, t, n) {
        ...
        function i(e, t, n) {
          function i(e, t) {
            if (0 !== e.length)
              for (w = e.length; w--; )
                (x = e[w]).callback.call(r, t, r), x.isOne && e.splice(w, 1);
          }
          var r = this;
          (this.watchItem = t),
            (this.container = e),
            (this.offsets = n
              ? n === +n
                ? { top: n, bottom: n }
                : { top: n.top || h.top, bottom: n.bottom || h.bottom }
              : h),
            (this.callbacks = {});
          ...
          (this.triggerCallbacks = function (e) {
            switch (
              ...
              this.isAboveViewport !== y &&
                ...
                (i(this.callbacks[a], e),
                g ||
                  this.isFullyInViewport ||
                  (i(this.callbacks[o], e), i(this.callbacks[u], e)),
                m ||
                  this.isInViewport ||
                  (i(this.callbacks[s], e), i(this.callbacks[l], e))),
              ...
              if (!this.locked) {
                ...
                if (this.watchItem.nodeName) {
                  ...
                  for (var r = 0, a = this.container; a.containerWatcher; )
                    (r +=
                      a.containerWatcher.top -
                      a.containerWatcher.container.viewportTop),
        ...
        setTimeout(function () {
          if (((d = document.documentElement.clientWidth), void 0 === c)) {
            ...
            t &&
              ...
              $(
                "#nav,header#header,#nav-overlay-content .content,.loader,.scroll-container .scroll-wrapper.on,section.case-study-next-project,.document-overlay,.loader-preloader,#nav footer"
              ).css("width", "calc(100% - " + n + "px)"),
              $("a.scroll-top").css("margin-right", n + "px"),
              -1 != navigator.userAgent.indexOf("Safari") &&
                -1 == navigator.userAgent.indexOf("Chrome") &&
                0 == p &&
                (mediaQueriesHelper.init(
