                ...
                t && t.preventDefault(),
                    ...
                    t.isDefaultPrevented() ||
                        ...
                        s.support.transition && n.hasClass('fade')
                            ? n.one('bsTransitionEnd', e).emulateTransitionEnd(a.TRANSITION_DURATION)
                            : e());
            });
        var t = s.fn.alert;
                ...
                i.length
                    ? ('radio' == (t = this.$element.find('input')).prop('type')
                          ...
                          : 'checkbox' == t.prop('type') &&
                            (t.prop('checked') !== this.$element.hasClass('active') && (e = !1),
    ...
    (function (p) {
        ...
        (c.VERSION = '3.3.7'),
            ...
            (c.prototype.slide = function (t, e) {
                ...
                var r,
                    l = o[0],
                    h = p.Event('slide.bs.carousel', { relatedTarget: l, direction: s });
                if ((this.$element.trigger(h), !h.isDefaultPrevented())) {
                    (this.sliding = !0),
                        n && this.pause(),
                        this.$indicators.length &&
                            (this.$indicators.find('.active').removeClass('active'),
                            (r = p(this.$indicators.children()[this.getItemIndex(o)])) && r.addClass('active'));
        ...
        function e(t) {
            var e,
                ...
                o,
                n = p(this),
                s = p(n.attr('data-target') || ((e = n.attr('href')) && e.replace(/.*(?=#[^\s]+$)/, '')));
            s.hasClass('carousel') &&
                ((i = p.extend({}, s.data(), n.data())),
                (o = n.attr('data-slide-to')) && (i.interval = !1),
                a.call(s, i),
            ...
            (r.prototype.backdrop = function (t) {
                ...
                if (this.isShown && this.options.backdrop) {
                    ...
                    if (
                        ...
                        return;
                    n
                        ? this.$backdrop.one('bsTransitionEnd', t).emulateTransitionEnd(r.BACKDROP_TRANSITION_DURATION)
                        : t();
                } else {
        ...
        (m.VERSION = '3.3.7'),
            ...
            (m.prototype.show = function () {
                ...
                if (this.hasContent() && this.enabled) {
                    ...
                    r &&
                        ...
                        (s =
                            'bottom' == s && d.bottom + c > h.bottom
                                ? 'top'
                                : 'top' == s && d.top - c < h.top
                                ? 'bottom'
                                : 'right' == s && d.right + p > h.width
                                ? 'left'
                                : 'left' == s && d.left - p < h.left
                                ? 'right'
                                : s),
                        o.removeClass(l).addClass(s));
                    var f = this.getCalculatedOffset(s, d, p, c);
                ...
                if ((this.$element.trigger(n), !n.isDefaultPrevented()))
                    return (
                        ...
                        g.support.transition && o.hasClass('fade')
                            ? o.one('bsTransitionEnd', e).emulateTransitionEnd(m.TRANSITION_DURATION)
                            : e(),
                        (this.hoverState = null),
                        this
                    );
            ...
            (m.prototype.getViewportAdjustedDelta = function (t, e, i, o) {
                ...
                var s,
                    ...
                    r,
                    l,
                    h = (this.options.viewport && this.options.viewport.padding) || 0,
                    d = this.getPosition(this.$viewport);
                return (
                    /right|left/.test(t)
                        ? ((s = e.top - h - d.scroll),
                          (a = e.top + h - d.scroll + o),
                          s < d.top ? (n.top = d.top - s) : a > d.top + d.height && (n.top = d.top + d.height - a))
                        : ((r = e.left - h),
                          (l = e.left + h + i),
                          r < d.left ? (n.left = d.left - r) : l > d.right && (n.left = d.left + d.width - l)),
                    n
                );
            }),
            ...
            (a.prototype.show = function () {
                ...
                a || (a = (a = n.attr('href')) && a.replace(/.*(?=#[^\s]*$)/, '')),
                    n.parent('li').hasClass('active') ||
                        ((t = s.find('.active:last a')),
                        (e = r.Event('hide.bs.tab', { relatedTarget: n[0] })),
                        (i = r.Event('show.bs.tab', { relatedTarget: t[0] })),
                        t.trigger(e),
                        n.trigger(i),
                        i.isDefaultPrevented() ||
                            ...
                            this.activate(o, o.parent(), function () {
                                t.trigger({ type: 'hidden.bs.tab', relatedTarget: n[0] }),
                                    n.trigger({ type: 'shown.bs.tab', relatedTarget: t[0] });
                            })));
            }),
