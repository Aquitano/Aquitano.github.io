!(function (e) {
    ...
    function p(e, t, n, o) {
        ...
        return (
            (i.className = 'mfp-' + e),
            n && (i.innerHTML = n),
            o ? t && t.appendChild(i) : ((i = d(i)), t && i.appendTo(t)),
            i
        );
    }
    function m(e, t) {
        g.ev.triggerHandler(n + e, t),
            g.st.callbacks &&
    ...
    function f(e) {
        return (
            (e === t && g.currTemplate.closeBtn) ||
                ((g.currTemplate.closeBtn = d(g.st.closeMarkup.replace('%title%', g.st.tClose))), (t = e)),
    ...
    (e.prototype = {
        ...
        open: function (e) {
            ...
            if (!g.isOpen) {
                (g.types = []),
                    (v = ''),
                    e.mainEl && e.mainEl.length ? (g.ev = e.mainEl.eq(0)) : (g.ev = h),
                    e.key
                        ? (g.popupsCache[e.key] || (g.popupsCache[e.key] = {}), (g.currTemplate = g.popupsCache[e.key]))
                        : (g.currTemplate = {}),
                    ...
                    g.bgOverlay ||
                        ((g.bgOverlay = p('bg').on('click' + w, function () {
                            g.close();
                        })),
                        (g.wrap = p('wrap')
                            .attr('tabindex', -1)
                ...
                m('BeforeOpen'),
                    ...
                    g.fixedContentPos
                        ...
                        : g.wrap.css({ top: k.scrollTop(), position: 'absolute' }),
                    (!1 !== g.st.fixedBgPos && ('auto' !== g.st.fixedBgPos || g.fixedContentPos)) ||
                        g.bgOverlay.css({ height: h.height(), position: 'absolute' }),
                    g.st.enableEscapeKey &&
                        h.on('keyup' + w, function (e) {
                ...
                g.fixedContentPos && g._hasScrollBar(s) && (a = g._getScrollbarSize()) && (l.marginRight = a),
                    g.fixedContentPos &&
                        (g.isIE7 ? d('body, html').css('overflow', 'hidden') : (l.overflow = 'hidden'));
                ...
                return (
                    ...
                    setTimeout(function () {
                        g.content ? (g._addClassToMFP(b), g._setFocus()) : g.bgOverlay.addClass(b),
                            h.on('focusin' + w, g._onFocusIn);
                    }, 16),
                    (g.isOpen = !0),
                    g.updateSize(s),
                    m(C),
        ...
        _close: function () {
            ...
            g.bgOverlay.detach(),
                ...
                g.fixedContentPos &&
                    ((e = { marginRight: '' }),
                    g.isIE7 ? d('body, html').css('overflow', '') : (e.overflow = ''),
                    d('html').css(e)),
                h.off('keyup.mfp focusin' + w),
                g.ev.off(w),
                g.wrap.attr('class', 'mfp-wrap').removeAttr('style'),
                g.bgOverlay.attr('class', 'mfp-bg'),
                g.container.attr('class', 'mfp-container'),
                !g.st.showCloseBtn ||
                    (g.st.closeBtnInside && !0 !== g.currTemplate[g.currItem.type]) ||
                    (g.currTemplate.closeBtn && g.currTemplate.closeBtn.detach()),
        ...
        updateItemHTML: function () {
            ...
            var t,
                n = e.type;
            m('BeforeChange', [g.currItem ? g.currItem.type : '', n]),
                (g.currItem = e),
                g.currTemplate[n] ||
                    ((t = !!g.st[n] && g.st[n].markup), m('FirstMarkupParse', t), (g.currTemplate[n] = !t || d(t))),
        ...
        appendContent: function (e, t) {
            (g.content = e)
                ? g.st.showCloseBtn && g.st.closeBtnInside && !0 === g.currTemplate[t]
                    ? g.content.find('.mfp-close').length || g.content.append(f())
                    : (g.content = e)
                : (g.content = ''),
                m('BeforeAppend'),
        ...
        parseEl: function (e) {
            var t,
                n = g.items[e];
            if ((n = n.tagName ? { el: d(n) } : ((t = n.type), { data: n, src: n.src })).el) {
        ...
        _openClick: function (e, t, n) {
            if (
                (void 0 !== n.midClick ? n.midClick : d.magnificPopup.defaults.midClick) ||
                ...
                e.type && (e.preventDefault(), g.isOpen && e.stopPropagation()),
                    (n.el = d(e.mfpEl)),
        ...
        updateStatus: function (e, t) {
            var n;
            g.preloader &&
                (o !== e && g.container.removeClass('mfp-s-' + o),
                t || 'loading' !== e || (t = g.st.tLoading),
                m('UpdateStatus', (n = { status: e, text: t })),
                (e = n.status),
                (t = n.text),
                g.preloader.html(t),
                        ...
                        void (1 < (r = e.split('_')).length
                            ? 0 < (n = i.find(w + '-' + r[0])).length &&
                              ('replaceWith' === (o = r[1])
                                  ...
                                  ? n.is('img')
                                      ? n.attr('src', t)
                                      : n.replaceWith(d('<img>').attr('src', t).attr('class', n.attr('class')))
                                  : n.attr(r[1], t))
                            : i.find(w + '-' + e).html(t))
                    );
                    var n, o;
        ...
        (d.fn.magnificPopup = function (e) {
            ...
            return (
                'string' == typeof e
                    ? 'open' === e
                        ? ((t = x ? i.data('magnificPopup') : i[0].magnificPopup),
                          (n = parseInt(arguments[1], 10) || 0),
                          (o = t.items ? t.items[n] : ((o = i), t.delegate && (o = o.find(t.delegate)), o.eq(n))),
                          g._openClick({ mfpEl: o }, i, t))
                ...
                if ((T(), e.src)) {
                    ...
                    return (
                        i.length
                            ? ((n = i[0].parentNode) &&
                                  n.tagName &&
                                  (P || ((_ = o.hiddenClass), (P = p(_)), (_ = 'mfp-' + _)),
                                  (S = i.after(P).detach().removeClass(_))),
                              g.updateStatus('ready'))
                            : (g.updateStatus('error', o.tNotFound), (i = d('<div>'))),
                        (e.inlineElement = i)
                    );
                }
                ...
                var e = d.extend(
                    {
                        ...
                        error: function () {
                            z(),
                                ...
                                g.updateStatus('error', g.st.ajax.tError.replace('%url%', i.src));
                        },
                    },
                    g.st.ajax.settings,
                );
            ...
            getImage: function (e, t) {
                var n,
                    ...
                    i = function () {
                        e &&
                            (e.img[0].complete
                                ? (e.img.off('.mfploader'),
                                  e === g.currItem && (g._onImageHasSize(e), g.updateStatus('ready')),
                                  (e.hasSize = !0),
                                  (e.loaded = !0),
                                  m('ImageLoadComplete'))
                                : ++o < 200
                    ...
                    r = function () {
                        e &&
                            (e.img.off('.mfploader'),
                            e === g.currItem &&
                                (g._onImageHasSize(e), g.updateStatus('error', a.tError.replace('%url%', e.src))),
                            (e.hasSize = !0),
                            (e.loaded = !0),
                            (e.loadError = !0));
                    },
                ...
                return (
                    s.length &&
                        ...
                        (e.img = d(n).on('load.mfploader', i).on('error.mfploader', r)),
                        (n.src = e.src),
                    ...
                    e.hasSize
                        ? (L && clearInterval(L),
                          e.loadError
                              ? (t.addClass('mfp-loading'), g.updateStatus('error', a.tError.replace('%url%', e.src)))
                              : (t.removeClass('mfp-loading'), g.updateStatus('ready')))
                        : (g.updateStatus('loading'),
                          (e.loading = !0),
                          e.hasSize || ((e.imgHidden = !0), t.addClass('mfp-loading'), g.findImageSize(e))),
                    t
                );
            },
        },
    ...
    d.magnificPopup.registerModule('zoom', {
        ...
        proto: {
            initZoom: function () {
                ...
                a.enabled &&
                    ...
                    u('BuildControls' + s, function () {
                        if (g._allowZoom()) {
                            if ((clearTimeout(t), g.content.css('visibility', 'hidden'), !(e = g._getItemToZoom())))
                                return void r();
                            (n = i(e)).css(g._getOffset()),
                                g.wrap.append(n),
                                (t = setTimeout(function () {
                                    n.css(g._getOffset(!0)),
                                        (t = setTimeout(function () {
                                            r(),
                                                setTimeout(function () {
                                                    n.remove(), (e = n = null), m('ZoomAnimationEnded');
                                                }, 16);
                                        }, o));
                                }, 16));
                        }
                    ...
                    u(c + s, function () {
                        if (g._allowZoom()) {
                            if ((clearTimeout(t), (g.st.removalDelay = o), !e)) {
                    ...
                    u(l + s, function () {
                        g._allowZoom() && (r(), n && n.remove(), (e = null));
                    }));
            },
            _allowZoom: function () {
            ...
            _getOffset: function (e) {
                ...
                var r = { width: t.width(), height: (x ? t.innerHeight() : t[0].offsetHeight) - i - o };
                return (
    ...
    function A(e) {
        var t;
        !g.currTemplate[F] ||
            ((t = g.currTemplate[F].find('iframe')).length &&
                (e || (t[0].src = '//about:blank'), g.isIE8 && t.css('display', e ? 'block' : 'none')));
    }
    var F = 'iframe';
    ...
    d.magnificPopup.registerModule('gallery', {
        ...
        proto: {
                    ...
                    !(!r || !r.enabled) &&
                        ...
                        u('BuildControls' + e, function () {
                            ...
                            1 < g.items.length &&
                                ...
                                ((e = r.arrowMarkup),
                                (t = g.arrowLeft =
                                    d(e.replace(/%title%/gi, r.tPrev).replace(/%dir%/gi, 'left')).addClass(I)),
                                (n = g.arrowRight =
                                    d(e.replace(/%title%/gi, r.tNext).replace(/%dir%/gi, 'right')).addClass(I)),
                                t.click(function () {
                                    g.prev();
                                }),
                                n.click(function () {
            ...
            _preloadItem: function (e) {
                ...
                (e = j(e)),
                    g.items[e].preloaded ||
                        ((t = g.items[e]).parsed || (t = g.parseEl(e)),
                        m('LazyLoad', t),
                        'image' === t.type &&
