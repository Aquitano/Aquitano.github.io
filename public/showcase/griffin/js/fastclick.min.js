!(function () {
    ...
    var t = 0 <= navigator.userAgent.indexOf('Windows Phone'),
        ...
        h = u && /OS ([6-9]|\d{2})_\d/.test(navigator.userAgent),
    ...
    (c.prototype.needsClick = function (t) {
        ...
        (c.prototype.focus = function (t) {
            var e;
            u && t.setSelectionRange && 0 !== t.type.indexOf('date') && 'time' !== t.type && 'month' !== t.type
        ...
        (c.prototype.onTouchEnd = function (t) {
            ...
            if (
                ...
                return (
                    100 < t.timeStamp - n || (u && window.top !== window && 'input' === o)
                        ? (this.targetElement = null)
                        : (this.focus(a),
                          this.sendClick(a, t),
                          (u && 'select' === o) || ((this.targetElement = null), t.preventDefault())),
                    !1
                );
            return (
                !(!u || l || !(i = a.fastClickScrollParent) || i.fastClickLastScrollTop === i.scrollTop) ||
        ...
        (c.notNeeded = function (t) {
            ...
            if (
                i &&
                10 <= (o = navigator.userAgent.match(/Version\/([0-9]*)\.([0-9]*)/))[1] &&
                3 <= o[2] &&
        ...
        'function' == typeof define && 'object' == typeof define.amd && define.amd
            ...
            ? ((module.exports = c.attach), (module.exports.FastClick = c))
            : (window.FastClick = c);
})();
