    ...
    (s = 0),
                ...
                if (
                    ('object' === a.type(arguments[0])
                        ...
                        : 'string' === a.type(arguments[0]) &&
                          ((o = arguments[1]),
                          (r = arguments[2]),
                          'responsive' === (t = arguments[0]) && 'array' === a.type(arguments[1])
                              ? (s = 'responsive')
                          ...
                          (s <= i && i <= n.slideCount - 1 - s
                              ...
                              : ((e = n.options.slidesToShow + i),
                                r
                                    ...
                                    .attr('aria-hidden', 'false')),
                          0 === i
                              ? r.eq(r.length - 1 - n.options.slidesToShow).addClass('slick-center')
                              : i === n.slideCount - 1 && r.eq(n.options.slidesToShow).addClass('slick-center')),
        ...
        (r.prototype.swipeDirection = function () {
            var i,
                ...
                s = Math.atan2(o, t);
            return (
                (i = Math.round((180 * s) / Math.PI)) < 0 && (i = 360 - Math.abs(i)),
